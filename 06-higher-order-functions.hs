...
higherOrderSum intApplication a b
    | a > b = (-higherOrderSum intApplication b a)
...
higherOrderSequenceApplication :: (Int -> Int) -> (Int -> Int -> Int) -> 
                                    Int -> Int -> Int -> Int
higherOrderSequenceApplication intApplication intFold a b z
    | a >= b = z
    | otherwise = intApplication a `intFold`
                (higherOrderSequenceApplication intApplication 
                                                intFold 
                                                (a + 1) 
                                                b 
                                                z)
...
hoFactorial :: Int -> Int
hoFactorial  x = higherOrderSequenceApplication (\x -> x) (*) 1 x x
